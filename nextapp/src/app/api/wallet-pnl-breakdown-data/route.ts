...
export async function POST(request: Request){
    ...
    const response = await fetch('https://deep-index.moralis.io/api/v2.2/wallets/' + body.address + '/profitability?chain=arbitrum', options) // Pass in address values for request
